        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            ...
            <button
              ...
              className="text-gray-400 hover:text-error-red transition-colors p-1"
              title="Remove item"
            >
              <svg
                className="w-5 h-5"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-dark-red min-w-[30px] text-center">
                  {item.quantity}
                </span>
                <button
                  onClick={() => handleQuantityChange(item.quantity + 1)}
            ...
            <div className="text-right">
              <div className="text-lg font-bold text-dark-red">
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <button
              ...
              className="text-sm text-dark-red hover:text-hover-red transition-colors flex items-center"
            >
              <svg
            ...
            {showInstructions && (
              <div className="mt-2">
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-dark-red focus:border-transparent resize-none"
                  rows={2}
                />
              </div>
            )}
